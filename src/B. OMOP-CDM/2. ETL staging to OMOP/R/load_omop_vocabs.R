...
load_omop_vocabs <- sapply(list_all_schemas_study_cdm$schema_name[grepl("vocabulary", list_all_schemas_study_cdm$schema_name)], function(x){
  nn <- x
  
  #Set path to your downloaded and unzipped Vocabularies from Athena
  path_concept_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\CONCEPT.csv")
  path_concept_relationship_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\CONCEPT_RELATIONSHIP.csv")
  path_concept_ancestor_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\CONCEPT_ANCESTOR.csv")
  path_concept_synonym_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\CONCEPT_SYNONYM.csv")
  path_drug_strength_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\DRUG_STRENGTH.csv")
  path_vocabulary_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\VOCABULARY.csv")
  path_relationship_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\RELATIONSHIP.csv")
  path_concept_class_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\CONCEPT_CLASS.csv")
  path_domain_vocabs <- glue::glue("D:\\APHRC\\OMOP-CDM\\Usagi and Vocabulary\\vocabulary_download_v5_1740563892891\\DOMAIN.csv")
