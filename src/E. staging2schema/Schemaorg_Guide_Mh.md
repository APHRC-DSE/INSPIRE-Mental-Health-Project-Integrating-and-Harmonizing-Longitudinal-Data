...
- [Understand the Purpose](#understand-the-purpose-introduction)
...
- [Model Variables Properly](#model-variables-properly-variablemeasured) (`variableMeasured`)
  - [Use PropertyValue for Individual-Level Clinical Concepts](#use-propertyvalue-for-individual-level-clinical-concepts)
